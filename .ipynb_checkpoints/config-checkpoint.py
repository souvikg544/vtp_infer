...
def load_args(parser=True):
    if parser == False:
        with open("../vtp/config.yaml", 'r') as file:
        ...
        parser.add_argument('--ckpt_path', default="/ssd_scratch/cvit/souvik/ft_lrs2.pth")
        parser.add_argument('--cnn_ckpt_path', default="/ssd_scratch/cvit/souvik/feature_extractor.pth")
        ...
        parser.add_argument('--max_decode_len', type=int, default=35)
