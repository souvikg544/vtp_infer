...
parser.add_argument('--min_track',      type=int, default=0,  help='Minimum facetrack duration');
...
def change_path(original_path):
  ...
  new_filename = f"{filename}_vtp"
  
  # Join the directory and new filename
  directory = directory.replace("/scratch/MEAD_DATA/MEAD_extracted/","/scratch/souvik/MEAD/")
...
crop_vid_path = change_path(opt.videofile)
for ii, track in enumerate(alltracks):
  vidtracks.append(crop_video(opt,track,crop_vid_path))
